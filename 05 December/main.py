# 05 December
# Elf Container Shipping
# Not proud of this one... Inspiration has been taken from Reddit after I got stuck.
...
# Get the first 8 lines
starting_ship = lines[:8]
...
input_stacks, instructions = [part.split("\n") for part in input_data.split("\n\n")]
stacks = parse_stack_text(input_stacks)
